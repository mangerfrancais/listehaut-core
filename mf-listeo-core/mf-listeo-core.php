<?php
/*
 * Plugin Name: MF Listeo-Core - Directory Plugin by Purethemes
 * Version: 1.2.7
...
define( 'REALTEO_PLUGIN_DIR', plugin_dir_path( __FILE__ )."../listeo-core" );
/* load CMB2 for meta boxes*/
if ( file_exists( dirname( __FILE__ ) . '/../listeo-core/lib/cmb2/init.php' ) ) {
	require_once dirname( __FILE__ ) . '/../listeo-core/lib/cmb2/init.php';
	require_once dirname( __FILE__ ) . '/../listeo-core/lib/cmb2-tabs/plugin.php';
} else {
	add_action( 'admin_notices', 'listeo_core_missing_cmb2' );
}
// Load plugin class files

require_once( dirname( __FILE__ ) . '/../listeo-core/includes/class-listeo-core-admin.php' );
require_once( dirname( __FILE__ ) . '/includes/class-listeo-core.php' );
...
function Listeo_Core () {
	// var_dump(pathinfo(__FILE__));exit;
	$path = pathinfo(__FILE__);
	$dir = dirname($path["dirname"]);
	$instance = Listeo_Core::instance( $dir."/listeo-core/listeo-core.php", '1.2.1' );
...
if ( ! class_exists( 'Gamajo_Template_Loader' ) ) {
	require_once dirname( __FILE__ ) . '/../listeo-core/lib/class-gamajo-template-loader.php';
}
include( dirname( __FILE__ ) . '/../listeo-core/includes/class-listeo-core-templates.php' );

include( dirname( __FILE__ ) . '/../listeo-core/includes/paid-listings/class-listeo-core-paid-listings.php' );
include( dirname( __FILE__ ) . '/../listeo-core/includes/paid-listings/class-wc-product-listing-package.php' );
include( dirname( __FILE__ ) . '/../listeo-core/includes/class-wc-product-listing-booking.php' );
